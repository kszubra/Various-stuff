...
public class Agent {
    ...
    /**
     *Jedną z metod, której użyjemy, jest metoda addTransformer, która pozwala na zmodyfikowanie kodu klasy. Metoda ta przyjmuje parametr typu ClassFileTransformer,
     * który jest interfejsem, my jako autorzy agenta musimy ten interfejs odpowiednio zaimplementować.
     * Agenty mogą być uruchamiane nie tylko jako procesy wrappujące naszą aplikację podczas uruchamiania.
     * Agent może również podłączyć się (ang. attach) do procesu, który jest już uruchomiony na maszynie JVM – w ten
     * sposób działają na przykład debuggery podłączające się do aplikacji na zdalnych maszynach. Metoda agentmain używana
     * jest (i wymagana) w trybie podłączania aplikacji do istniejącego procesu, natomiast metoda premain używana jest (i wymagana) podczas
     * wrappowania uruchamiania naszej aplikacji.
     */
