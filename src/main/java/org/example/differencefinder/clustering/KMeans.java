...
public class KMeans {
    ...
    public static Map<Centroid, List<ClusterRecord>> fit(List<ClusterRecord> records, int k, Distance distance, int maxIterations) {
        ...
        for (int i = 0; i < maxIterations; i++) {
            ...
            System.out.println("Iteration: " + i + "/" + maxIterations + " completed in " + duration.toMillis() + "ms");
        }
     ...
     */
    private static void assignToCluster(Map<Centroid, List<ClusterRecord>> clusters, ClusterRecord record, Centroid centroid) {
     ...
     */
    private static Centroid nearestCentroid(ClusterRecord record, List<Centroid> centroids, Distance distance) {
    ...
    private static void applyPreconditions(List<ClusterRecord> records, int k, Distance distance, int maxIterations) {
        if (records == null || records.isEmpty()) {
